...
namespace UserService.Tests
{
    public class UserServiceTests
    {
        ...
        private readonly Mock<RabbitMqPublisher> _rabbitRepositoryMock;
        private readonly Application.Services.UserService _userService;

        public UserServiceTests()
        {
            _userRepositoryMock = new Mock<IUserRepository>();
            _rabbitRepositoryMock = new Mock<RabbitMqPublisher>();
            _userService = new Application.Services.UserService(_userRepositoryMock.Object, _rabbitRepositoryMock.Object);
